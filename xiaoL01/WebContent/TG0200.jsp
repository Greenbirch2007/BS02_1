            ...
            <table border="1" class="manage-table" id="manageTable">
                ...
                <c:forEach var="row" items="${vo }">
                    <tr>
                        ...
                        <td>¥<fmt:formatNumber value="${ row.jyutyuuMoney }" pattern="#,#00" /> </td>
...
<script>document.write("<script type='text/javascript' src='${pageContext.request.contextPath}/js/TG0200.js?'><\/script>");</script>
</body>
</html>